...
jobname="compete_transformer_lm"
fairseq-train --task language_modeling \
    ...
    --fp16-init-scale 4 \
    --user-dir compete_moe \
    --arch transformer_lm_compete \
    ...
    --criterion compete_moe_loss --moe-gate-loss-wt 0.01 --moe-gate-loss-combine-method sum \