...
from .moe import SMoELayer

class SmoeTransformerEncoder(TransformerEncoder):
...
class SmoeEncoderLayer(TransformerEncoderLayer):
    ...
    def build_moe_layer(self, gate, experts, args):
        return SMoELayer(gate, experts, args, self.embed_dim, self.layer_idx, autoregressive=False)
