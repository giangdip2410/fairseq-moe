...
@register_model("smoe")
class SmoeTransformer(TransformerModel):
    @classmethod
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return SmoeTransformerEncoder(args, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return SmoeTransformerDecoder(
            args,
            tgt_dict,
            embed_tokens,
    ...
    def add_args(parser):
        ...
        parser.add_argument('--smoe-type', type=str, default='seq', 
