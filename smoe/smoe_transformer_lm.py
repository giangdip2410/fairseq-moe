...
from .smoe_encoder import SmoeTransformerEncoder
from .smoe_decoder import SmoeTransformerDecoder
...
@dataclass
class TransformerSmoeLanguageModelConfig(FairseqDataclass):
    #new
    # parser.add_argument('--ratio1', type=float, default=0., help="ratio for intra-accelerator communication")
    ratio1: float = field(default=0.0, metadata={"help": "ratio for intra-accelerator communication"})
    # parser.add_argument('--ratio2', type=float, default=0., help="ratio for intra-node communication")
    ratio2: float = field(default=0.0, metadata={"help": "ratio for intra-accelerator communication"})
    ratio3: float = field(default=0.0, metadata={"help": "ratio for intra-accelerator communication"})
    capacity_factor: float = field(default=1.25, metadata={"help": "ratio for intra-accelerator communication"})
    ...
    temperature: float = field(default=1.0, metadata={"help": "temperature for df-gate, only make sense if df-gate-type=sigmoid"})
    # parser.add_argument('--token-cluster', action='store_true', default=False, help="")
    token_cluster: bool = field(
        default=False,
        metadata={"help": "Token Cluster"},
    )
    # parser.add_argument('--reorder-layers', action='store_true', default=False, help="")
    reorder_layers: bool = field(
        default=False,
        metadata={"help": "reorder-layers"},
    )
    # parser.add_argument('--scomoe-type', type=str, default='seq', 
    #     choices=['feat','seq', 'none'], help="")
    scomoe_type: str = field(default='seq', metadata={"help": "choices=['feat','seq', 'none']"})
    # parser.add_argument('--gate-type', type=str, default='softmax',
    #     choices=['softmax','sigmoid',])
    gate_type: str = field(default='softmax', metadata={"help": "choices=['softmax','sigmoid',]"})
    # parser.add_argument('--layernorm-after-moe-layer', action='store_true', default=False)
    layernorm_after_moe_layer: bool = field(default=False, metadata={"help": "layernorm-after-moe-layer"})
...
@register_model("smoe_transformer_lm", dataclass=TransformerSmoeLanguageModelConfig)
class SmoeTransformerLanguageModel(FairseqLanguageModel):
    @classmethod
    def hub_models(cls):
    ...
    def build_model(cls, args, task):
        ...
        decoder = SmoeTransformerDecoder(
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_big")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_wiki103")
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_baevski_wiki103")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gbw")
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_baevski_gbw")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt2_small")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt2_tiny")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt2_medium")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt2_big")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt2_big_wide")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt2_bigger")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_small")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_medium")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_large")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_xl")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_2_7")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_6_7")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_13")
...
@register_model_architecture("smoe_transformer_lm", "smoe_transformer_lm_gpt3_175")
