...
from .gates import CustomNaiveGate
...
#     def __init__(self, gate, experts, d_model, layer_idx, args) -> None:
  
        
#         experts = FMoETransformerMLP()
#         gate = CustomNaiveGate(d_model=d_model, num_expert=8, world_size=1)
        
#         super().__init__(gate, experts,  d_model, layer_idx,args)
#         self.layer_idx = layer_idx
  
        
#     def forward(self, *input: Tensor, input_padding_mask=None, **kwargs: Any):
    
#         return self.super().forward(input, input_padding_mask, *kwargs)
