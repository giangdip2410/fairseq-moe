...
@register_model_architecture("lm", "lm_tiny")
def transformerlm_tiny(args):
...
@register_model_architecture("lm", "lm_small")
def transformerlm_small(args):
