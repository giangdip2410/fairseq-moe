...
from .brainformer_decoder import BrainformerDecoder
...
@register_model("brainformerlm", dataclass=LanguageConfig)
...
class LMDecoder(BrainformerDecoder, FairseqIncrementalDecoder):
...
@register_model_architecture("brainformerlm", "brainformerlm_base")
...
@register_model_architecture("brainformerlm", "brainformerlm_tiny")
...
@register_model_architecture("brainformerlm", "brainformerlm_small")
...
@register_model_architecture("brainformerlm", "brainformerlm_medium")
...
@register_model_architecture("brainformerlm", "brainformerlm_large")
