...
@register_model("competelm", dataclass=LanguageConfig)
...
@register_model_architecture("competelm", "competelm_base")
...
@register_model_architecture("competelm", "competelm_tiny")
def competelm_tiny(args):
...
@register_model_architecture("competelm", "competelm_small")
def competelm_small(args):
...
@register_model_architecture("competelm", "competelm_medium")
def competelm_medium(args):
    args.decoder_layers = getattr(args, "decoder_layers", 6)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 512)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 16)
...
@register_model_architecture("competelm", "competelm_large")
def competelm_large(args):
