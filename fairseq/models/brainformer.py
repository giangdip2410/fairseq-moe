...
def fsdp_wrap_expert(args, layer, min_num_params=0):
    ...
    if dist_utils.get_data_parallel_group() is not None:
...
class BrainformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--moe-freq', type=int, metavar='D', default=0,
                            help='Frequency at which we insert MoE Brainformer layers')
        parser.add_argument('--encoder-moe-freq', type=int, metavar='D', default=0,
                            help='Frequency at which we insert MoE Brainformer encoder layers')
        parser.add_argument('--decoder-moe-freq', type=int, metavar='D', default=0,
                            help='Frequency at which we insert MoE Brainformer decoder layers')
...
class BrainformerEncoder(FairseqEncoder):
    ...
    def build_encoder_layer(self, args, is_moe_layer=False):
        layer = BrainformerEncoderLayer(args, is_moe_layer=is_moe_layer)
...
class BrainformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        # compute self-attention padding mask (involves device-to-host Brainfer,
