...
@register_model("brainformer_lm", dataclass=BrainformerLanguageModelConfig)
class BrainformerLanguageModel(FairseqLanguageModel):
    ...
    def hub_models(cls):
        ...
        return {
            "brainformer_lm.gbw.adaptive_huge": "https://dl.fbaipublicfiles.com/fairseq/models/lm/adaptive_lm_gbw_huge.tar.bz2",
            "brainformer_lm.wiki103.adaptive": "https://dl.fbaipublicfiles.com/fairseq/models/lm/adaptive_lm_wiki103.v2.tar.bz2",
            "brainformer_lm.wmt19.en": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt19.en.tar.bz2"
            ),
            "brainformer_lm.wmt19.de": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt19.de.tar.bz2"
            ),
            "brainformer_lm.wmt19.ru": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt19.ru.tar.bz2"
            ),
            "brainformer_lm.wmt20.en": spm(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt20.en.tar.gz"
            ),
            "brainformer_lm.wmt20.ta": spm(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt20.ta.tar.gz"
            ),
            "brainformer_lm.wmt20.iu.news": spm(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt20.iu.news.tar.gz"
            ),
            "brainformer_lm.wmt20.iu.nh": spm(
...
@register_model_architecture("brainformer_lm", "brainformer_lm_tiny")
def brainformer_lm_tiny(args):
...
@register_model_architecture("brainformer_lm", "brainformer_lm_small")
...
@register_model_architecture("brainformer_lm", "brainformer_lm_medium")
...
@register_model_architecture("brainformer_lm", "brainformer_lm_large")
...
@register_model_architecture("brainformer_lm", "brainformer_lm_big")
def brainformer_lm_big(args):
    args.decoder_layers = getattr(args, "decoder_layers", 12)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_wiki103")
@register_model_architecture("brainformer_lm", "brainformer_lm_baevski_wiki103")
def brainformer_lm_baevski_wiki103(args):
    ...
    brainformer_lm_big(args)


@register_model_architecture("brainformer_lm", "brainformer_lm_gbw")
@register_model_architecture("brainformer_lm", "brainformer_lm_baevski_gbw")
def brainformer_lm_baevski_gbw(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.dropout = getattr(args, "dropout", 0.1)
    args.attention_dropout = getattr(args, "attention_dropout", 0.1)
    args.no_decoder_final_norm = getattr(args, "no_decoder_final_norm", True)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt")
def brainformer_lm_gpt(args):
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt2_small")
def brainformer_lm_gpt2_small(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 1024)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 4096)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt2_tiny")
def brainformer_lm_gpt2_tiny(args):
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt2_medium")
def brainformer_lm_gpt2_medium(args):
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt2_big")
def brainformer_lm_gpt2_big(args):
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt2_big_wide")
def brainformer_lm_gpt2_big_wide(args):
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt2_bigger")
def brainformer_lm_gpt2_bigger(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 2048)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 8192)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_small")
def brainformer_lm_gpt3_small(args):
    # 125M params
    args.decoder_layers = getattr(args, "decoder_layers", 12)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 768)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 12)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_medium")
def brainformer_lm_gpt3_medium(args):
    # 350M params
    args.decoder_layers = getattr(args, "decoder_layers", 24)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 1024)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 16)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_large")
def brainformer_lm_gpt3_large(args):
    # 760M params
    args.decoder_layers = getattr(args, "decoder_layers", 24)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_xl")
def brainformer_lm_gpt3_xl(args):
    # 1.3B params
    args.decoder_layers = getattr(args, "decoder_layers", 24)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 2048)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 32)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_2_7")
def brainformer_lm_gpt3_2_7(args):
    # 2.7B params
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_6_7")
def brainformer_lm_gpt3_6_7(args):
    # 6.7B params
    args.decoder_layers = getattr(args, "decoder_layers", 32)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_13")
def brainformer_lm_gpt3_13(args):
    # 13B params
    args.decoder_layers = getattr(args, "decoder_layers", 40)
...
@register_model_architecture("brainformer_lm", "brainformer_lm_gpt3_175")
def brainformer_lm_gpt3_175(args):
    # 175B params
