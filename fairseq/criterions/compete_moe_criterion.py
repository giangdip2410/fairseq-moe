...
import sys
sys.path.append("/home/gtruong/Project/ICML/Fair_MOE/fairseq-moe/compete_moe")
...
@dataclass
class CompeteMoECriterionConfig(FairseqDataclass):
...
# @register_criterion("compete_moe_loss", dataclass=CompeteMoECriterionConfig)
class CompeteMoECriterion(FairseqCriterion):
...
@register_criterion("compete_moe_loss", dataclass=CompeteMoECriterionConfig)
class MoECrossEntropyCriterion(CompeteMoECriterion):
