...
@register_model("transformer_lm_stable", dataclass=TransformerLanguageModelConfig)
class TransformerLanguageModel(FairseqLanguageModel):
    ...
    def hub_models(cls):
        ...
        return {
            "transformer_lm_stable.gbw.adaptive_huge": "https://dl.fbaipublicfiles.com/fairseq/models/lm/adaptive_lm_gbw_huge.tar.bz2",
            "transformer_lm_stable.wiki103.adaptive": "https://dl.fbaipublicfiles.com/fairseq/models/lm/adaptive_lm_wiki103.v2.tar.bz2",
            "transformer_lm_stable.wmt19.en": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt19.en.tar.bz2"
            ),
            "transformer_lm_stable.wmt19.de": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt19.de.tar.bz2"
            ),
            "transformer_lm_stable.wmt19.ru": moses_fastbpe(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt19.ru.tar.bz2"
            ),
            "transformer_lm_stable.wmt20.en": spm(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt20.en.tar.gz"
            ),
            "transformer_lm_stable.wmt20.ta": spm(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt20.ta.tar.gz"
            ),
            "transformer_lm_stable.wmt20.iu.news": spm(
                "https://dl.fbaipublicfiles.com/fairseq/models/lm/wmt20.iu.news.tar.gz"
            ),
            "transformer_lm_stable.wmt20.iu.nh": spm(
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_tiny")
def transformer_lm_stable_tiny(args):
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_small")
def transformer_lm_stable_small(args):
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_medium")
def transformer_lm_stable_medium(args):
    args.decoder_layers = getattr(args, "decoder_layers", 6)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 512)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 16)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_large")
def transformer_lm_stable_large(args):
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_big")
def transformer_lm_stable_big(args):
    args.decoder_layers = getattr(args, "decoder_layers", 12)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_wiki103")
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_baevski_wiki103")
def transformer_lm_stable_baevski_wiki103(args):
    ...
    transformer_lm_stable_big(args)


@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gbw")
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_baevski_gbw")
def transformer_lm_stable_baevski_gbw(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
    args.dropout = getattr(args, "dropout", 0.1)
    args.attention_dropout = getattr(args, "attention_dropout", 0.1)
    args.no_decoder_final_norm = getattr(args, "no_decoder_final_norm", True)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt")
def transformer_lm_stable_gpt(args):
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt2_small")
def transformer_lm_stable_gpt2_small(args):
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 1024)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 4096)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt2_tiny")
def transformer_lm_stable_gpt2_tiny(args):
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt2_medium")
def transformer_lm_stable_gpt2_medium(args):
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt2_big")
def transformer_lm_stable_gpt2_big(args):
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_BaseGPT_x1_large")
def transformer_lm_stable_BaseGPT_x1_large(args):
    # GPT2
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_BaseGPT_x1_medium")
def transformer_lm_stable_BaseGPT_x1_medium(args):
    # GPT2
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 1024)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 4096)
    args.decoder_layers = getattr(args, "decoder_layers", 24)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_BaseGPT_x1_small")
def transformer_lm_stable_BaseGPT_x1_small(args):
    # GPT2
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 768)
    args.decoder_ffn_embed_dim = getattr(args, "decoder_ffn_embed_dim", 3072)
    args.decoder_layers = getattr(args, "decoder_layers", 12)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_small")
def transformer_lm_stable_gpt3_small(args):
    # 125M params
    args.decoder_layers = getattr(args, "decoder_layers", 12)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 768)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 12)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_medium")
def transformer_lm_stable_gpt3_medium(args):
    # 350M params
    args.decoder_layers = getattr(args, "decoder_layers", 24)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 1024)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 16)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_large")
def transformer_lm_stable_gpt3_large(args):
    # 760M params
    args.decoder_layers = getattr(args, "decoder_layers", 24)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 1536)
    args.decoder_attention_heads = getattr(args, "decoder_attention_heads", 16)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_xl")
def transformer_lm_stable_gpt3_xl(args):
    # 1.3B params
    args.decoder_layers = getattr(args, "decoder_layers", 24)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_2_7")
def transformer_lm_stable_gpt3_2_7(args):
    # 2.7B params
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_6_7")
def transformer_lm_stable_gpt3_6_7(args):
    # 6.7B params
    args.decoder_layers = getattr(args, "decoder_layers", 32)
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_13")
def transformer_lm_stable_gpt3_13(args):
    # 13B params
...
@register_model_architecture("transformer_lm_stable", "transformer_lm_stable_gpt3_175")
def transformer_lm_stable_gpt3_175(args):
    # 175B params
